...
$requestData = $_REQUEST;
	...
	$query2 = "select distinct 
			...
			patient_sample , patient_sample_date,patient_evaluation_date from fimm.micha_protocols p  where protocol_name='$protocol' 
	...
	$query2 = "select distinct 
			...
			patient_sample , patient_sample_date,patient_evaluation_date from fimm.micha_protocols p  where protocol_name='$protocol' 
			    ";
						...
						analysis_ref, analysis_metric from fimm.micha_protocols p  where protocol_name='$protocol' 
			  ...
			  or analysis_metric LIKE '%".strtoupper($requestData['search']['value'])."%' ) ";
			   ...
			   analysis_metric from fimm.micha_protocols p  where protocol_name='$protocol' ";
			...
			if($requestData['search']['value']){
				$query2 = "	select distinct dilution_fold , vehicle , experimental_medium , plate_type , 
							...
							volume_per_well , treatment_time from fimm.micha_protocols p  where protocol_name='$protocol' 
			  ...
			  or volume_per_well LIKE '%".strtoupper($requestData['search']['value'])."%') 
			   ...
			   $query3 ="	select distinct dilution_fold , vehicle , experimental_medium , plate_type , 
				...
				if($requestData['search']['value']){
				$query2 = "select distinct 
						   compound_name , standard_inchi_key from fimm.micha_protocols p  where protocol_name='$protocol' 
